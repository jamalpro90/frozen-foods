...
import { funcRegister } from '../config/firebase';
...
function Register() {
  ...
  const handleRegister = (e) => {
    e.preventDefault();
    funcRegister(router, email, password);
    setEmail('');
    setPassword('');
  };
    ...
    <div className="bg-gray-200">
      <div className="container mx-auto flex justify-center items-center h-screen">
        ...
        <div className="bg-teal-600 p-6 rounded-lg shadow-lg">
          {/* Title Box */}
          <h2 className="text-white font-robo font-bold text-4xl text-center mb-4">Register</h2>
